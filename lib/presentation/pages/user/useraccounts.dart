    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            isEditing = false;
            displayButtomSheet(
                context, const UserAccount(institutionName: ''), ref);
          }),
    ...
    return PopupMenuButton(
        itemBuilder: (BuildContext context) => <PopupMenuEntry>[
              PopupMenuItem(
                onTap: () {
                  isEditing = true;
                  displayButtomSheet(context, userAccount, ref);
                },
              ...
              PopupMenuItem(
                ...
                onTap: () {
                  Future.delayed(
                      ...
                      () async => (ref
                          .read(userAccountsProvider.notifier)
                          .makeInstituitionDefault(userAccount.id.toString())));
                },
...
Future<dynamic> displayButtomSheet(
    BuildContext context, UserAccount userAccount, WidgetRef ref) {
  if (!isEditing) {
    ...
    institutionName.text = userAccount.institutionName.toString();
    institutionAddress.text = userAccount.institutionAddress.toString();
    institutionEmail.text = userAccount.institutionEmail.toString();
    institutionTelephone.text = userAccount.institutionTelephone.toString();
  }
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                            ...
                            onPressed: (() async {
                              UserAccount userAccountEdit = UserAccount(
                              ...
                              if (!isEditing) {
                                await ref
                                    .read(userAccountsProvider.notifier)
                                    .addUserAccount(userAccountEdit)
                                    .then(
                                        (value) => Navigator.of(context).pop());
                              } else {
                                await ref
                                    .read(userAccountsProvider.notifier)
                                    .updateUserAccount(userAccountEdit)
                                    .then(
                                        (value) => Navigator.of(context).pop());
                                ;
                              }
